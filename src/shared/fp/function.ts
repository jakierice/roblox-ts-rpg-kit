 ...
 * @since 2.0.0
 */
export function fpNot<A>(predicate: Predicate<A>): Predicate<A> {
 ...
 * @since 2.0.0
 */
export const constNull: Lazy<undefined> =
  /*#__PURE__*/
  constant(undefined)
...
export function flow(
  ...
  const args = [ab, bc, cd, de, ef, fg, gh, hi, ij]
  switch (args.size()) {
    case 1:
      return ab
    case 2:
      return function (this: unknown) {
        return bc!(ab(this, ...args))
      }
    case 3:
      return function (this: unknown) {
        return cd!(bc!(ab(this, ...args)))
      }
    case 4:
      return function (this: unknown) {
        return de!(cd!(bc!(ab([this, ...args]))))
      }
    case 5:
      return function (this: unknown) {
        return ef!(de!(cd!(bc!(ab([this, ...args])))))
      }
    case 6:
      return function (this: unknown) {
        return fg!(ef!(de!(cd!(bc!(ab([this, ...args]))))))
      }
    case 7:
      return function (this: unknown) {
        return gh!(fg!(ef!(de!(cd!(bc!(ab([this, ...args])))))))
      }
    case 8:
      return function (this: unknown) {
        return hi!(gh!(fg!(ef!(de!(cd!(bc!(ab([this, ...args]))))))))
      }
    case 9:
      return function (this: unknown) {
        return ij!(hi!(gh!(fg!(ef!(de!(cd!(bc!(ab([this, ...args])))))))))
      }
  }
}
...
export const bind_ = <A, N extends string, B>(
  ...
  Object.assign({}, a, { [name]: b }) as any // eslint-disable-line @typescript-eslint/no-explicit-any
...
export const bindTo_ = <N extends string>(name: N) => <B>(
  b: B
): { [K in N]: B } => ({ [name]: b } as any) // eslint-disable-line @typescript-eslint/no-explicit-any
